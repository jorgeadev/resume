variable "kafka_connect_resources_limits_cpu" {
  type    = "string"
  default = "1000m"
}

variable "kafka_connect_resources_limits_memory" {
  type    = "string"
  default = "1024Mi"
}

variable "kafka_connect_resources_requests_cpu" {
  type    = "string"
  default = "100m"
}

variable "kafka_connect_resources_requests_memory" {
  type    = "string"
  default = "512Mi"
}

# TODO - finish adding dependencies / internal / external flags
resource "helm_chart" "kafka_connect" {
  name = "kafka-connect"
  chart = "kafka-connect"
  ...
  set {
    name = "ingress.hosts"
    value = "{kafka-connect.celmatix.net}"
  }

  set {
    name = "resources.limits.cpu"
    value = "${var.kafka_connect_resources_limits_cpu}"
  }

  set {
    name = "resources.limits.memory"
    value = "${var.kafka_connect_resources_limits_memory}"
  }

  set {
    name = "resources.requests.cpu"
    value = "${var.kafka_connect_resources_requests_cpu}"
  }

  set {
    name = "resources.requests.memory"
    value = "${var.kafka_connect_resources_requests_memory}"
  }
}
